...
threshold1 = 5.
threshold2 = 10.
test_weight = torch.tensor([[1., 2., 3.],[1., 2., 5.],[1., 5., 5.],[1., 5., 9.],[5., 9., 12.],[10., 20., 30.]])
the_max = test_weight.max(dim=1, keepdim=True)
print(the_max, "the_max")
gt_t1 = test_weight.gt(threshold1)
print(gt_t1, "gt_t1")
exceed = the_max.values-threshold1
exceed = exceed.abs()+epi
mul_me = (threshold2-threshold1)/exceed
test_weight_1 = gt_t1*((test_weight-threshold1)*mul_me+threshold1)+(gt_t1.logical_not())*test_weight
...
class DigitalMapper_V2(torch.nn.Module):
    ...
    def __init__(self, in_features: int, out_features: int, \
        ...
        self.auto_merge_duration = auto_merge_duration 
        self.update_count = 0 
        pass
