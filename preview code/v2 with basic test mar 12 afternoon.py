...
For all test:
Aligning the avg length of gradients for each layer is optional, but maybe it also help. 
I didn't test this detail carefully. 
...
In most cases:
sigmoid style doesn't work well with narrow model. The reason can be the loss function(MSE). 
It may work better with other act func.
The output of sigmoid doesn't look very accurate.
But relu style works better.///////////////////////////
...
Mirror Sigmoid/ReLU:
All the test seem to work properly. Again, I stack 10 layers and they train very quickly.


The last one, the combination of the previous 2.
The MIG(MI-rror with G-ramo)(HELP ME NAME IT)
Known issue is, it doesn't work in some cases.
