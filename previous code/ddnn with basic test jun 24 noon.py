...
'''
    def __get_offset(self)->float:
    def get_output_range(self, input_range:BoundaryPair)->BoundaryPair:
    def forward(self, input: torch.Tensor) -> torch.Tensor:
...
input_range = BoundaryPair.from_float(0., 1.)
layer = Binarize_base(True, input_range, trivial_big_number, True)
...
'''01 to np'''
trivial_big_number = 1.
layer = Binarize_base(0, trivial_big_number, False,)
input = torch.tensor([[0., 0.5, 1.]], requires_grad=True)
...
'''non 01 to 01'''
trivial_big_number = 1.
layer = Binarize_base(1, trivial_big_number, False,)
input = torch.tensor([[-1., 0., 1.]], requires_grad=True)
print(layer(input), "should be <0.5, ==0.5, >0.5")
layer = Binarize_base(2, trivial_big_number, False,)
input = torch.tensor([[-1., 0., 1.]], requires_grad=True)
print(layer(input), "should be <0.5, ==0.5, >0.5")
