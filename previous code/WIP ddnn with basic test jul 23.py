...
# model = DSPU(input.shape[1],target.shape[1],1,1,1,num_layers=1, scaling_ratio_for_gramo_in_mapper=200.)
...
# model = DSPU(input.shape[1],target.shape[1],1,1,1,num_layers=1, 
...
# model = DSPU(input.shape[1],target.shape[1],4,4,4,num_layers=4, 
#              scaling_ratio_for_gramo_in_mapper=1000.,
#              scaling_ratio_for_gramo_in_mapper_for_out_mapper=2000.)
# model.get_info(directly_print=True)
# #model.set_auto_print_difference_between_epochs()
...
f16, bit=1,layer=3,gates=8,batch=50,lr=0.001,noise_base=1.5>>> at least it works. <3k epochs.
f16, bit=2,layer=6,gates=32,batch=500,lr=0.001,noise_base=1.5>>>
'''
...
(bit, layer, gates, batch, lr) = test_config_dispatcher(bit=2,layer=6,gates=660,batch=100,lr=0.001)
is_f16 = True
iter_per_print = 1#1111
print_count = 20000
noise_base = 1.2#1.5better#2.
