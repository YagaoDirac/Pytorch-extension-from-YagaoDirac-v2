...
'''some real training'''
in_feature = 2
model = DigitalMapper_Non_standard(in_feature,1)
...
class DigitalSignalProcessingUnit(torch.nn.Module):
...
class DSPU_10(torch.nn.Module):
    ...
    def __init__(self, in_features: int, out_features: int, \
        ...
        factory_kwargs = {'device': device, 'dtype': dtype}
        super().__init__()
        self.DSPU1 = DigitalSignalProcessingUnit(in_features, and_gates, or_gates, xor_gates)
        dspu_out = self.DSPU1.get_out_feature()
        self.DSPU2 = DigitalSignalProcessingUnit(dspu_out, and_gates, or_gates, xor_gates)
        self.DSPU3 = DigitalSignalProcessingUnit(dspu_out, and_gates, or_gates, xor_gates)
        self.DSPU4 = DigitalSignalProcessingUnit(dspu_out, and_gates, or_gates, xor_gates)
        self.DSPU5 = DigitalSignalProcessingUnit(dspu_out, and_gates, or_gates, xor_gates)
        self.DSPU6 = DigitalSignalProcessingUnit(dspu_out, and_gates, or_gates, xor_gates)
        self.DSPU7 = DigitalSignalProcessingUnit(dspu_out, and_gates, or_gates, xor_gates)
        self.DSPU8 = DigitalSignalProcessingUnit(dspu_out, and_gates, or_gates, xor_gates)
        self.DSPU9 = DigitalSignalProcessingUnit(dspu_out, and_gates, or_gates, xor_gates)
        self.DSPU10 = DigitalSignalProcessingUnit(dspu_out, and_gates, or_gates, xor_gates)
        #end of function        
    ...
    def get_out_feature(self)->int:
        return self.DSPU10.get_out_feature()
...
class example_1_layer_of_DSPU(torch.nn.Module):
    ...
    def __init__(self, in_features: int, out_features: int, \
        ...
        self.DSPU = DigitalSignalProcessingUnit(in_features, and_gates, or_gates, xor_gates)
        self.out_mapper_in_features = self.DSPU.get_out_feature()
        self.out_mapper_out_features = out_features
        
        self.out_mapper = DigitalMapper(self.out_mapper_in_features, self.out_mapper_out_features)
