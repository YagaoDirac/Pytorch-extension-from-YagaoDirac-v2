...
# Because I already tested the gramo layer in MIG, I don't plan to redo them here.'''
# layer = layer = Binarize_np_to_01(1.)
# input = torch.tensor([[0., 0.]], requires_grad=True)
# output = layer(input)
# g_in = torch.tensor([[0.12, 0.12]])
# torch.autograd.backward(output, g_in,inputs= input)
...
#         self.Binarize1 = Binarize_np_to_01(3.)
#         self.Binarize2 = Binarize_01(6.)
#         self.Binarize3 = Binarize_01(6.)
#         pass
    
#     def get_output_range(self, range_input:BoundaryPair)->BoundaryPair:
#         r = range_input
...
# print(layer1.get_output_range(BoundaryPair.make_np()))

# layer3 = example_Binarize_01_3times()
# input:torch.Tensor = torch.tensor([-1., -0.5, 0., 0.5, 1.], dtype=torch.float32, requires_grad=True,)
# input = input.unsqueeze(0)
# output = layer3(input)
...
# print(layer3.get_output_range(BoundaryPair.make_np()))
...
class AND_01(torch.nn.Module):
    ...
    def get_output_range(self, input: torch.Tensor)->Tuple[torch.Tensor,torch.Tensor]:
