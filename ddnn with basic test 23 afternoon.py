...
'''
   ...
   1 def scale_back_to_01
   1 def scale_back_to_np
'''
...
# x = bp01.calc_boundary_01(6.).calc_boundary_01(6.).calc_boundary_01(6.)
# y = bp01.calc_boundary_01(6., steps=3)
# print(x, "should be ",y)

x = bp01.calc_boundary_non01_to_01(5.).calc_boundary_non01_to_01(5.).calc_boundary_non01_to_01(5.)
...
x = bpnp.calc_boundary_non01_to_01(5.).calc_boundary_non01_to_01(5.).calc_boundary_non01_to_01(5.)
