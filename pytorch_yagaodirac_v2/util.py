...
def reverse_interpolation_of_list__sequencial__list_must_sorted(the_list:torch.Tensor, list_is_Ascending:bool, the_input:torch.Tensor, 
                                _debug__Im_sure_the_list_is_sorted = False)->torch.Tensor:
    '''the list must be sorted!!!'''
    if not _debug__Im_sure_the_list_is_sorted:
...
if "test" and __DEBUG_ME__() and False:
    def ____test____reverse_interpolation_of_list__sequencial__list_must_sorted():
        the_list = torch.tensor([12.,16,20,30])
        result = reverse_interpolation_of_list__sequencial__list_must_sorted(the_list, list_is_Ascending=True, the_input = torch.tensor(12.))
        assert _tensor_equal(result, [0.])
        result = reverse_interpolation_of_list__sequencial__list_must_sorted(the_list, list_is_Ascending=True, the_input = torch.tensor(11.))
        assert _tensor_equal(result, [0.])
        result = reverse_interpolation_of_list__sequencial__list_must_sorted(the_list, list_is_Ascending=True, the_input = torch.tensor(30.))
        assert _tensor_equal(result, [3.])
        result = reverse_interpolation_of_list__sequencial__list_must_sorted(the_list, list_is_Ascending=True, the_input = torch.tensor(31.))
        assert _tensor_equal(result, [3.])
        
        result = reverse_interpolation_of_list__sequencial__list_must_sorted(the_list, list_is_Ascending=True, the_input = torch.tensor(14.))
        assert _tensor_equal(result, [0.5])
        result = reverse_interpolation_of_list__sequencial__list_must_sorted(the_list, list_is_Ascending=True, the_input = torch.tensor(13.))
        assert _tensor_equal(result, [0.25])
        result = reverse_interpolation_of_list__sequencial__list_must_sorted(the_list, list_is_Ascending=True, the_input = torch.tensor(17.))
        assert _tensor_equal(result, [1.25])
        result = reverse_interpolation_of_list__sequencial__list_must_sorted(the_list, list_is_Ascending=True, the_input = torch.tensor(28.))
        assert _tensor_equal(result, [2.8])
        
        
        the_list = torch.tensor([12.,16,20,30])*-1.
        result = reverse_interpolation_of_list__sequencial__list_must_sorted(the_list, list_is_Ascending=False, the_input = torch.tensor(-12.))
        assert _tensor_equal(result, [0.])
        result = reverse_interpolation_of_list__sequencial__list_must_sorted(the_list, list_is_Ascending=False, the_input = torch.tensor(-11.))
        assert _tensor_equal(result, [0.])
        result = reverse_interpolation_of_list__sequencial__list_must_sorted(the_list, list_is_Ascending=False, the_input = torch.tensor(-30.))
        assert _tensor_equal(result, [3.])
        result = reverse_interpolation_of_list__sequencial__list_must_sorted(the_list, list_is_Ascending=False, the_input = torch.tensor(-31.))
        assert _tensor_equal(result, [3.])
        
        result = reverse_interpolation_of_list__sequencial__list_must_sorted(the_list, list_is_Ascending=False, the_input = torch.tensor(-14.))
        assert _tensor_equal(result, [0.5])
        result = reverse_interpolation_of_list__sequencial__list_must_sorted(the_list, list_is_Ascending=False, the_input = torch.tensor(-13.))
        assert _tensor_equal(result, [0.25])
        result = reverse_interpolation_of_list__sequencial__list_must_sorted(the_list, list_is_Ascending=False, the_input = torch.tensor(-17.))
        assert _tensor_equal(result, [1.25])
        result = reverse_interpolation_of_list__sequencial__list_must_sorted(the_list, list_is_Ascending=False, the_input = torch.tensor(-28.))
        assert _tensor_equal(result, [2.8])
...
def ____unfinished____reverse_interpolation_of_list__binary_search(the_list:torch.Tensor, list_is_Ascending:bool, the_input:torch.Tensor, 
                                _debug__Im_sure_the_list_is_sorted = False)->torch.Tensor:
    '''the list must be sorted!!!'''
    if not _debug__Im_sure_the_list_is_sorted:
        if list_is_Ascending:
...
if "test" and __DEBUG_ME__() and True:
    def ____test____reverse_interpolation_of_list():
        ...
        if "ascending" and True:
            #long list
            the_list = torch.tensor([12.,16,20,30])
            result = reverse_interpolation_of_list__list_must_sorted(the_list, list_is_Ascending=True, the_input = torch.tensor(12.))
            assert _tensor_equal(result, [0.])
            result = reverse_interpolation_of_list__list_must_sorted(the_list, list_is_Ascending=True, the_input = torch.tensor(11.))
            assert _tensor_equal(result, [0.])
            result = reverse_interpolation_of_list__list_must_sorted(the_list, list_is_Ascending=True, the_input = torch.tensor(30.))
            assert _tensor_equal(result, [3.])
            result = reverse_interpolation_of_list__list_must_sorted(the_list, list_is_Ascending=True, the_input = torch.tensor(31.))
            assert _tensor_equal(result, [3.])
            
            result = reverse_interpolation_of_list__list_must_sorted(the_list, list_is_Ascending=True, the_input = torch.tensor(14.))
            assert _tensor_equal(result, [0.5])
            result = reverse_interpolation_of_list__list_must_sorted(the_list, list_is_Ascending=True, the_input = torch.tensor(13.))
            assert _tensor_equal(result, [0.25])
            result = reverse_interpolation_of_list__list_must_sorted(the_list, list_is_Ascending=True, the_input = torch.tensor(17.))
            assert _tensor_equal(result, [1.25])
            result = reverse_interpolation_of_list__list_must_sorted(the_list, list_is_Ascending=True, the_input = torch.tensor(28.))
            assert _tensor_equal(result, [2.8])
            
            # around 256?
            the_list = torch.arange(1000, dtype=torch.float32)
            assert the_list.nelement() == 1000
            result = reverse_interpolation_of_list__list_must_sorted(the_list, list_is_Ascending=True, the_input = torch.tensor(0.3))
            assert _tensor_equal(result, [0.3])
            result = reverse_interpolation_of_list__list_must_sorted(the_list, list_is_Ascending=True, the_input = torch.tensor(1.3))
            assert _tensor_equal(result, [1.3])
            for ii in range(999):
                result = reverse_interpolation_of_list__list_must_sorted(the_list, list_is_Ascending=True, the_input = torch.tensor(ii+0.))
                assert _tensor_equal(result, [ii+0.])
                pass
            result = reverse_interpolation_of_list__list_must_sorted(the_list, list_is_Ascending=True, the_input = torch.tensor(998.))
            assert _tensor_equal(result, [998.])
            result = reverse_interpolation_of_list__list_must_sorted(the_list, list_is_Ascending=True, the_input = torch.tensor(999.))
            assert _tensor_equal(result, [999.])
            result = reverse_interpolation_of_list__list_must_sorted(the_list, list_is_Ascending=True, the_input = torch.tensor(999.5))
            assert _tensor_equal(result, [999.])
            
            the_list = torch.arange(1000, dtype=torch.float32)+2.
            assert the_list.nelement() == 1000
            result = reverse_interpolation_of_list__list_must_sorted(the_list, list_is_Ascending=True, the_input = torch.tensor(2.3))
            assert _tensor_equal(result, [0.3])
            result = reverse_interpolation_of_list__list_must_sorted(the_list, list_is_Ascending=True, the_input = torch.tensor(3.3))
            assert _tensor_equal(result, [1.3])
            for ii in range(999):
                result = reverse_interpolation_of_list__list_must_sorted(the_list, list_is_Ascending=True, the_input = torch.tensor(ii+2.))
                assert _tensor_equal(result, [ii+0.])
                pass
            result = reverse_interpolation_of_list__list_must_sorted(the_list, list_is_Ascending=True, the_input = torch.tensor(1000.))
            assert _tensor_equal(result, [998.])
            result = reverse_interpolation_of_list__list_must_sorted(the_list, list_is_Ascending=True, the_input = torch.tensor(1001.))
            assert _tensor_equal(result, [999.])
            result = reverse_interpolation_of_list__list_must_sorted(the_list, list_is_Ascending=True, the_input = torch.tensor(1001.5))
            assert _tensor_equal(result, [999.])
            ...
            for n_element in [256, 257, 258, 65532, 65533, 65534, 65535, 65536, 65537, 65538, ]:
                ...
                result = reverse_interpolation_of_list__list_must_sorted(the_list, list_is_Ascending=True, the_input = torch.tensor(-11.))
                assert _tensor_equal(result, [0.])
                result = reverse_interpolation_of_list__list_must_sorted(the_list, list_is_Ascending=True, the_input = torch.tensor(-2.))
                assert _tensor_equal(result, [0.9])
                
                result = reverse_interpolation_of_list__list_must_sorted(the_list, list_is_Ascending=True, the_input = torch.tensor(3.))
                assert _tensor_equal(result, [n_element-1.])
                result = reverse_interpolation_of_list__list_must_sorted(the_list, list_is_Ascending=True, the_input = torch.tensor(2.))
                assert _tensor_equal(result, [n_element-1.])
                result = reverse_interpolation_of_list__list_must_sorted(the_list, list_is_Ascending=True, the_input = torch.tensor(1.123))
        ...
        if "decending" and True:
            #long list
            the_list = torch.tensor([12.,16,20,30])*-1.
            result = reverse_interpolation_of_list__list_must_sorted(the_list, list_is_Ascending=False, the_input = torch.tensor(-12.))
            assert _tensor_equal(result, [0.])
            result = reverse_interpolation_of_list__list_must_sorted(the_list, list_is_Ascending=False, the_input = torch.tensor(-11.))
            assert _tensor_equal(result, [0.])
            result = reverse_interpolation_of_list__list_must_sorted(the_list, list_is_Ascending=False, the_input = torch.tensor(-30.))
            assert _tensor_equal(result, [3.])
            result = reverse_interpolation_of_list__list_must_sorted(the_list, list_is_Ascending=False, the_input = torch.tensor(-31.))
            assert _tensor_equal(result, [3.])
            
            result = reverse_interpolation_of_list__list_must_sorted(the_list, list_is_Ascending=False, the_input = torch.tensor(-14.))
            assert _tensor_equal(result, [0.5])
            result = reverse_interpolation_of_list__list_must_sorted(the_list, list_is_Ascending=False, the_input = torch.tensor(-13.))
            assert _tensor_equal(result, [0.25])
            result = reverse_interpolation_of_list__list_must_sorted(the_list, list_is_Ascending=False, the_input = torch.tensor(-17.))
            assert _tensor_equal(result, [1.25])
            result = reverse_interpolation_of_list__list_must_sorted(the_list, list_is_Ascending=False, the_input = torch.tensor(-28.))
            assert _tensor_equal(result, [2.8])
            
            # around 256?
            the_list = torch.arange(1000, dtype=torch.float32)*-1.
            assert the_list.nelement() == 1000
            result = reverse_interpolation_of_list__list_must_sorted(the_list, list_is_Ascending=False, the_input = torch.tensor(-0.3))
            assert _tensor_equal(result, [0.3])
            result = reverse_interpolation_of_list__list_must_sorted(the_list, list_is_Ascending=False, the_input = torch.tensor(-1.3))
            assert _tensor_equal(result, [1.3])
            for ii in range(999):
                result = reverse_interpolation_of_list__list_must_sorted(the_list, list_is_Ascending=False, the_input = torch.tensor(-1.*ii))
                assert _tensor_equal(result, [ii+0.])
                pass
            result = reverse_interpolation_of_list__list_must_sorted(the_list, list_is_Ascending=False, the_input = torch.tensor(-998.))
            assert _tensor_equal(result, [998.])
            result = reverse_interpolation_of_list__list_must_sorted(the_list, list_is_Ascending=False, the_input = torch.tensor(-999.))
            assert _tensor_equal(result, [999.])
            result = reverse_interpolation_of_list__list_must_sorted(the_list, list_is_Ascending=False, the_input = torch.tensor(-999.5))
            assert _tensor_equal(result, [999.])
            
            the_list = torch.arange(1000, dtype=torch.float32)*-1.-2.
            assert the_list.nelement() == 1000
            result = reverse_interpolation_of_list__list_must_sorted(the_list, list_is_Ascending=False, the_input = torch.tensor(-2.3))
            assert _tensor_equal(result, [0.3])
            result = reverse_interpolation_of_list__list_must_sorted(the_list, list_is_Ascending=False, the_input = torch.tensor(-3.3))
            assert _tensor_equal(result, [1.3])
            for ii in range(999):
                result = reverse_interpolation_of_list__list_must_sorted(the_list, list_is_Ascending=False, the_input = torch.tensor(-1.*ii-2.))
                assert _tensor_equal(result, [ii+0.])
                pass
            result = reverse_interpolation_of_list__list_must_sorted(the_list, list_is_Ascending=False, the_input = torch.tensor(-1000.))
            assert _tensor_equal(result, [998.])
            result = reverse_interpolation_of_list__list_must_sorted(the_list, list_is_Ascending=False, the_input = torch.tensor(-1001.))
            assert _tensor_equal(result, [999.])
            result = reverse_interpolation_of_list__list_must_sorted(the_list, list_is_Ascending=False, the_input = torch.tensor(-1001.5))
            assert _tensor_equal(result, [999.])
            ...
            for n_element in [256, 257, 258, 65532, 65533, 65534, 65535, 65536, 65537, 65538, ]:
                ...
                result = reverse_interpolation_of_list__list_must_sorted(the_list, list_is_Ascending=False, the_input = torch.tensor(11.))
                assert _tensor_equal(result, [0.])
                result = reverse_interpolation_of_list__list_must_sorted(the_list, list_is_Ascending=False, the_input = torch.tensor(2.))
                assert _tensor_equal(result, [0.9])
                
                result = reverse_interpolation_of_list__list_must_sorted(the_list, list_is_Ascending=False, the_input = torch.tensor(-3.))
                assert _tensor_equal(result, [n_element-1.])
                result = reverse_interpolation_of_list__list_must_sorted(the_list, list_is_Ascending=False, the_input = torch.tensor(-2.))
                assert _tensor_equal(result, [n_element-1.])
                result = reverse_interpolation_of_list__list_must_sorted(the_list, list_is_Ascending=False, the_input = torch.tensor(-1.123))
                assert _tensor_equal(result, [n_element-2.+0.123], epsilon=result*1e-7)
                pass
...
if "test" and __DEBUG_ME__() and True:
    ...
    1w
    1w
    2 version should behavior the same way.
