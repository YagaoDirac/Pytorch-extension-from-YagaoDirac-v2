...
class DigitalMapperFunction_v2_1(torch.autograd.Function):
    ...
    def backward(ctx, g_in_b_o):
        ...
        if threshold_for_random>=0.75:
            ...
            pass
        flag_positive_of_grad_for_raw_weight__raw__o_i = grad_for_raw_weight__raw__o_i.gt(0.)
        grad_for_raw_weight_o_i = flag_positive_of_grad_for_raw_weight__raw__o_i*grad_for_raw_weight__raw__o_i*neg_g_enhancing_factor+grad_for_raw_weight__raw__o_i
